...
def TreeBuild(S, Player):
    ...
    while (WinOrNot == False) and (DrawChecker==False):
        ...
        for i in possiblemoves:
            values = values + [minimax(i, Player, Player)]
        nextmove = values.index(max(values))
...
def minimax(S, Player, Player1):
    ...
    if Player == Player1:
        for i in possiblemoves:
            values = values + [minimax(i, Player, Player1)]
        return max(values)
    else:
        for i in possiblemoves:
            values = values + [minimax(i, Player, Player1)] 
